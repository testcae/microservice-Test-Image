...
import i5.las2peer.services.testImage.database.DatabaseManager;
import java.sql.*;
...
public class TestImage extends RESTService {
  ...
  @Api
  @SwaggerDefinition(
      info = @Info(title = "Test Image", version = "$Metadata_Version$",
          description = "$Metadata_Description",
          termsOfService = "$Metadata_Terms",
          contact = @Contact(name = "Melisa", email = "CAEAddress@gmail.com") ,
          license = @License(name = "BSD",
              url = "https://github.com/testcae/microservice-Test-Image/blob/master/LICENSE.txt") ) )
  @Path("/")
